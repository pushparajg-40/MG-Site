...
function AboutImageSection({ title, subtitle, childs, image }: AboutProps) {
    ...
    <>
      <div className="pt-[100px] dark:bg-[#181818] transition-all duration-500 ease-in">
        <section className="flex flex-col justify-center items-center pt-20 pb-8 dark:bg-[#000000]  transition-all duration-500 ease-in ">
          <p className="text-[#1783F7] dark:text-white font-semibold text-4xl pb-7 2xl-plus:max-w-9xl 2xl-plus:mx-auto">
            {title}
          </p>
          <p className="text-[#687DA9] dark:text-white font-normal text-[48px] leading-[1.2] text-center pb-5 2xl-plus:max-w-9xl 2xl-plus:mx-auto">
            {subtitle}
          </p>
        </section>
        ...
        <div className="dark:bg-[#000000]">
          <section
            className={`w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-${gridCols} 2xl-plus:grid-cols-2  2xl-plus:max-w-9xl 2xl-plus:mx-auto  gap-10   p-10 justify-items-center items-start  transition-all duration-500 ease-in`}
          >
            {childs.map((child) => {
              return (
                <>
