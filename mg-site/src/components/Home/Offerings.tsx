    ...
    <>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 px-10 md:px-[50px] lg:px-[120px] 2xl-plus:max-w-9xl 2xl-plus:mx-auto ">
          <div className="relative bg-white transition-all duration-700 ease-in hover:scale-105 border border-gray-200 dark:border-gray-800 rounded-lg overflow-hidden shadow-sm dark:shadow-none">
            <div className="absolute inset-0 flex items-start justify-start">
              <div className="text-black z-10 p-2 md:p-4">
                <h2 className="text-lg lg:text-xl font-bold mb-2 text-[#1783F7] dark:text-black">
                  Data
                  <br /> Innovation
                </h2>
