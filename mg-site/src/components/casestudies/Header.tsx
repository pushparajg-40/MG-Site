  ...
  return (
    <section className="scroll-animate mx-auto pl-6 py-10 dark:bg-[#000000] transition-all duration-500 ease-in">
      <div className="flex flex-col lg:flex-row gap-8">
        <div className="lg:w-2/3 lg:pl-[100px] lg:pt-[50px] lg:pr-[30px]">
          <h1 className="text-[#1783F7] dark:text-white text-5xl font-bold mb-4">
            {title}
          </h1>
          <p className="text-2xl leading-normal text-[#667085] dark:text-white mb-4">
            {subtitle}
          </p>
          <p className="text-sm leading-relaxed text-[#667085] dark:text-white">
            {desc}
          </p>
        </div>
