          ...
          <div className="max-w-7xl mx-auto flex flex-col-reverse md:grid md:grid-cols-2 gap-10 items-center">
            <div className="z-10">
              ...
              <p className="text-[#667085] dark:text-white leading-relaxed text-sm sm:text-base px-4">
                In today’s fast-paced digital economy, organizations require
                more than just standalone systems — they need a connected
                ecosystem that seamlessly unifies operations, customer
                engagement, and data intelligence. Mindgraph specializes in
                building integrated enterprise platforms by aligning ERP and CRM
                systems with intelligent automation and AI-driven insights. From
                implementation to continuous optimization, we help businesses
                unlock the full potential of their enterprise technology stack —
                enabling data-driven decisions, streamlined operations, and
