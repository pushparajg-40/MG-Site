          ...
          <div className="max-w-7xl mx-auto flex flex-col-reverse md:grid md:grid-cols-2 gap-10 items-center">
            <div className="z-10">
              ...
              <p className="text-[#667085] dark:text-white leading-relaxed text-sm sm:text-base px-4">
                ...
                empowers enterprises to modernize their infrastructure and
                unlock the full potential of the cloud. Our Cloud &
                Infrastructure Services are designed to accelerate
                transformation through robust cloud-native architectures,
                seamless automation, and optimized performance across public,
                private, and hybrid environments. We work closely with
                organizations to assess, design, implement, and manage cloud
                strategies tailored to their business goals — whether it's
                scaling rapidly, reducing costs, or improving resilience. Our
