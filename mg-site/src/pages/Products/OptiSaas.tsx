    ...
    <main className="transition-all duration-500 ease-in">
      ...
      >
        ...
        <div className="hero-section flex flex-col w-full md:w-1/2 justify-center items-start pl-12 pr-0 md:pr-[70px]">
          ...
          <button className="w-60 text-white dark:text-black font-semibold py-3 px-8 rounded-full flex items-center justify-center transition-all hover:opacity-90 bg-gradient-to-r from-[#8B8B8B] to-[#1783F7] dark:from-white dark:to-white dark:bg-white hover:from-[#787878] hover:to-[#0653A7] dark:hover:from-gray-200 dark:hover:to-gray-400">
            Talk to Our Experts
            <img
              src={
                isDark
      ...
      <section className="bg-[#F6FAFF] dark:bg-[#181818] transition-all duration-500 ease-in pt-16 md:pt-8 pb-8">
        <div className="flex flex-col justify-center items-center text-center">
          ...
          <p className="text-[#687DA9] dark:text-white font-normal text-3xl md:text-5xl leading-tight mb-5 px-4">
            A Platform Your Entire Business <br className="hidden md:block" />{" "}
            will Love
          </p>
          <p className="text-[#667085] dark:text-white font-normal text-base leading-6 max-w-3xl px-4">
            ...
            With unmatched functionality, ease of use, and efficiency, it's the
            solution your entire organization <br className="hidden md:block" />{" "}
            will love.
          </p>
        </div>
      </section>
        ...
        <div className="section-5 mt-16 md:mt-0">
          ...
          <div className="flex flex-col justify-start items-start pl-5 md:pl-10 pr-2 md:pr-0">
            ...
            <p className="text-[#667085] dark:text-white font-normal text-base leading-6 mb-5">
              ...
              designed to enhance user experience with intelligent, intuitive
              support.
            </p>
            <ul className="text-[#666666] dark:text-white font-normal text-base leading-6 list-disc ml-8">
          ...
          <div className="flex flex-col justify-start items-start pl-5 md:pl-10 pr-2 md:pr-0">
            ...
            <p className="text-[#667085] dark:text-white font-normal text-base leading-6 mb-5">
              At OptiSaaSAI, we focus on value and flexibility, offering free
              integrations with top SaaS platforms and a dynamic connectors
              framework to provide a robust, adaptable solution for your
              business.
            </p>
            <ul className="text-[#666666] dark:text-white font-normal text-base leading-6 list-disc ml-8">
