...
export default function OpsBeat() {
  ...
  "
          ...
          <p className="text-white md:text-[#667085] dark:text-white text-base mb-6">
            Revolutionize your IT operations with smart automation, real-time
            visibility, and seamless integrations. OpsBeat brings speed,
            simplicity, and scale to modern service management.
          </p>

          <button className="mt-6 w-full sm:w-[240px] text-white dark:text-black font-semibold py-3 px-8 rounded-full flex items-center justify-center bg-gradient-to-r from-[#8B8B8B] to-[#1783F7] hover:from-[#787878] hover:to-[#0653A7] dark:bg-white dark:hover:from-gray-200 dark:hover:to-gray-400 transition-all">
            Talk to Our Experts
            <img
      ...
      <section className="section-between lg:flex flex-row dark:bg-[#181818] transition-all duration-500 ease-in px-6 lg:px-20 py-16 lg:py-20">
        <div className="mb-10 lg:mb-0 lg:w-1/2">
          ...
          <p className="text-base lg:text-[16px] text-[#666666] dark:text-white leading-[150%]">
            OpsBeat is more than an ITSM tool—it's a powerful platform built to
            streamline IT workflows, drive operational efficiency, and provide
            deep insight into service performance. With low-code customization,
            robust automation, and built-in AI, OpsBeat transforms how your
            teams manage IT services.
          </p>
        </div>
