          ...
          <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10">
            <div className="md:w-1/2 mt-8 md:mt-0 order-2 md:order-1">
              ...
              <p className="text-[#667085] dark:text-white text-base leading-relaxed">
                ...
                Services that bridge the gap between strategy and execution.
                With a focus on transformation, innovation, and
                future-readiness, we partner with enterprises to navigate
                complex business challenges and rapidly evolving technologies.
                Our industry-aligned approach ensures that digital investments
                are purpose-driven, scalable, and aligned with measurable
                outcomes. Whether you’re reimagining operations, adopting AI, or
                building digital resilience, we provide the insight and
            ...
            <div className="w-full lg:w-1/3 flex justify-center lg:justify-end lg:-mt-20 z-10 md:hidden">
              <div className="max-w-sm lg:max-w-md overflow-hidden bg-white px-[20px] mt-[10px]">
                <img
                  ...
                  src="/assets/capabilitiesConsultancyUpdated.png"
                  alt="AI Hand"
        ...
        <section className="py-16 px-4 sm:px-8 lg:px-20 text-center">
          ...
          <div className="mt-12">
            ...
            <p className=" text-[#687DA9] dark:text-white  text-3xl md:px-[150px]">
              Partner with Mindgraph to shape a digitally resilient,
