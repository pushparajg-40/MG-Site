            ...
            <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10">
              <div className="md:w-1/2 mt-8 md:mt-0 order-2 md:order-1">
                ...
                <p className="text-[#667085] dark:text-white text-base leading-relaxed">
                  ...
                  We enable businesses to convert raw, scattered, and complex
                  data into meaningful insights and actionable intelligence. Our
                  services span the entire data lifecycle—from foundational data
                  engineering to advanced AI and machine learning (ML)
                  deployment. By leveraging cutting-edge technologies, we
                  empower our clients to make data-driven decisions, improve
