          ...
          <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10">
            <div className="md:w-1/2 mt-8 md:mt-0 order-2 md:order-1">
              ...
              <p className="text-[#667085] dark:text-white text-base leading-relaxed">
                ...
                solutions that drive operational efficiency, business agility,
                and digital innovation. Our SAP services portfolio spans
                consulting, implementation, upgrades, and managed
                support—ensuring that your SAP landscape remains optimized,
                secure, and future-ready. Whether you're embarking on an SAP
                S/4HANA transformation, enhancing your existing modules, or
                migrating to the cloud, we provide the expertise and frameworks
                needed for seamless execution and long-term success.
              </p>
            </div>
