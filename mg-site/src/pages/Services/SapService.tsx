            ...
            <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10">
              <div className="md:w-1/2 mt-8 md:mt-0 order-2 md:order-1">
                ...
                <p className="text-[#667085] dark:text-white text-base leading-relaxed">
                  At Mindgraph, we specialize in delivering robust SAP
                  enterprise solutions that drive operational efficiency,
                  business agility, and digital innovation. Our SAP services
                  portfolio spans consulting, implementation, upgrades, and
                  managed support—ensuring that your SAP landscape remains
                  optimized, secure, and future-ready. Whether you're embarking
                  on an SAP S/4HANA transformation, enhancing your existing
                  modules, or migrating to the cloud, we provide the expertise
                  and frameworks needed for seamless execution and long-term
                  success.
                </p>
              </div>
          ...
          <section className="py-16 px-4 sm:px-8 lg:px-20">
            <div className="max-w-7xl mx-auto">
              ...
              <p className="text-[#667085] dark:text-white text-base sm:text-lg xl:pr-[400px]">
                We combine technical depth and industry-specific insights to
                deliver value across the SAP ecosystem
              </p>
