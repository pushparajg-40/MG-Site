...
// --- Interface for Solution Item Data ---
...
const defaultSolution = solutionItemsData[0]; // Assuming MathOps is the default
    ...
    <div className="dark:bg-black">
      ...
      <div className="w-full">
        <div className="relative h-[180px] lg:h-[280px] w-full">
          {/* NOTE: In React, paths usually need to be public or imported */}
          <img
        ...
        <div className="order-1 lg:order-2">
          <div className=" pl-[20px] pr-[10px] md:pr-0 md:pl-[60px]">
            ...
            <p className="mt-[10px] [font-family:'Roboto',Helvetica] font-normal text-[#667085] dark:text-white text-lg tracking-[0] leading-[26px]">
              Mindgraph is a next-generation technology company specializing in
              AI-powered solutions, data platforms, and digital transformation
              services. We partner with forward-thinking enterprises to
              modernize operations, drive growth, and deliver intelligent
              customer experiences across industries including energy,
              healthcare, BFSI, telecom, aviation, and manufacturing.
            </p>
          </div>
          <div className="pl-[20px] md:pl-[40px] pr-[10px] md:pr-0">
            ...
            >
              ...
              <p className="mt-[10px] [font-family:'Roboto',Helvetica] font-normal text-[#667085] dark:text-white text-base md:text-lg tracking-[0] leading-[26px]">
                To be the trusted partner for enterprises worldwide, enabling
                intelligent transformation through AI, data, and digital
                innovation.
              </p>
            </div>
          </div>
          <div className="pl-[20px] md:pl-[40px] pr-[10px] md:pr-0">
            ...
            >
              ...
              <p className="mt-[10px] [font-family:'Roboto',Helvetica] font-normal text-[#667085] dark:text-white text-base md:text-lg tracking-[0] leading-[26px]">
                ...
                industries, and drive sustainable growth by delivering AI-first
                platforms, cloud-native solutions, and strategic
        ...
        <div className="relative w-[800px] h-[650px] ">
          ...
          <div className="absolute inset-0 flex items-center justify-center z-20">
            <div className="relative bg-white dark:bg-black w-[500px] h-[180px] rounded-[140px] flex flex-col items-center justify-center text-center px-4 transition-all duration-500 ease-in">
              ...
              {/* Main Content */}
              <h2 className="text-3xl font-semibold text-[#687DA9]">
                What We do
              </h2>
              <p className="text-sm text-[#667085] max-w-[360px] mt-2">
                We offer a comprehensive suite of services and products to help
                businesses accelerate transformation:
              </p>
            </div>
          </div>
          ...
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 flex flex-col items-center z-10">
            ...
            />
            <span className="text-sm text-[#7E7E7E] dark:text-white text-center pt-1">
          ...
          <div className="absolute top-[15%] left-[85%] transform -translate-x-1/2 flex flex-col items-center z-10">
            <img
              ...
              className="w-[40px] h-[40px]"
            />
            <span className="text-sm text-[#7E7E7E] dark:text-white pt-1 text-center">
          ...
          <div className="absolute bottom-[15%] left-[15%] transform -translate-x-1/2 flex flex-col items-center z-10">
            <img
              src="assets/cloudInfra.svg"
              alt="Cloud Icon"
              className="w-[40px] h-[40px]"
            />
            <span className="text-sm text-[#7E7E7E] dark:text-white pt-1 text-center pl-[60px] md:pl-0 pr-[50px] md:pr-0">
      ...
      >
        ...
        >
          ...
          <h1
            ref={setRef}
            className="text-4xl text-black dark:text-[#055CC0] mb-4 leading-tight md:px-0 font-extrabold text-radiant opacity-0 translate-y-10 transition-all duration-700 ease-out"
            data-delay="300"
          >
    ...
    ${
      currentSolution.selector === item.selector
        ...
        : "hover:text-[#687DA9] dark:hover:text-white hover:font-semibold"
                  ...
                  onMouseLeave={() => fadeSolutionImageChange(defaultSolution)} // ✅ FIX
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 px-10 md:px-[50px] lg:px-[120px] ">
          ...
          >
            <div className="absolute inset-0 flex items-start justify-start">
              <div className="text-white dark:text-black z-10 p-2 md:p-8 md:pr-[50px] md:pr-0">
            ...
            />
            <img
              src="/assets/offering1.png"
              alt="Data Innovation"
              className="md:h-[372px] w-full object-cover rounded-3xl asp dark:hidden"
            />
          </div>
          ...
          >
            ...
            />
            <img
              src="/assets/offering3.png"
              alt="Data Innovation"
              className="md:h-[372px] w-full object-cover rounded-3xl dark:hidden"
            />
          </div>
        </div>
      </section>
